...
export default class Crypto {
  ...
  decryptData(encryptedData, iv) {
    ...
    if (!encryptedData) return { errcode: 9404, errmsg: 'encryptedData undefined' };
    ...
    if (decoded.watermark && decoded.watermark.appid !== WEAPP_APPID) {
      return { errmsg: 9406, errcode: 'appid不匹配', remote: decoded.watermark.appid, local: WEAPP_APPID };
    }
    return decoded;
  }
}
